...
import static com.example.poolrdriver.Abstract.GoogleMaps.getLocationFromAddress;
...
import com.example.poolrdriver.ui.activities.other.CreateNetworkSuccess;
    ...
    private void validateInput() {
        ...
        checkIfCodeExists(code, new Callback() {
            ...
            public void onSuccess(Object object) {
                ...
                network.setNetworkAcceptOnCode(networkRules.getSelectedItemPosition() == 0);
