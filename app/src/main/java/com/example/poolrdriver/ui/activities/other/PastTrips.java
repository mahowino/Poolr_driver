...
import static com.example.poolrdriver.Firebase.FirebaseRepository.getTripsInCollection;
...
public class PastTrips extends AppCompatActivity {
    ...
    private void initializeVariables() {
        ...
        recyclerView=findViewById(R.id.pastTripsView);
    }
    private void getUserNetworks() {
        ...
        getTripsInCollection(createCollectionReference(path), new Callback() {
            ...
            public void onError(Object object) {
                Toast.makeText(PastTrips.this, "error ", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getTripsFromNetwork(String networkID) {
        ...
        Query tripsQuery=createCollectionReference(FirebaseConstants.NETWORKS+"/"+networkID+"/"+FirebaseConstants.RIDES)
                ...
                .whereLessThanOrEqualTo(FirebaseFields.DEPARTURETIME,currentDate);
    ...
    private void initializeRecyclerView() {
        ...
        MyTripsAdapter adapter=new MyTripsAdapter(tripsList,getApplicationContext(),PastTrips.this,false);
